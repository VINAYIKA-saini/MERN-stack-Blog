        ...
        <Box>
            ...
            <Wrapper>
                ...
                <Text variant="h5">I'm a Software Engineer based in India. 
                    I've built websites, some backend projects like Ecommerce site(Flipcart,amazon etc),Url Shortner,college intern etc.<br />
                    If you are interested, you can view some of my favorite projects here
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/VINAYIKA-saini" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
